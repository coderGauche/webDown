...
> 当前状态：M2-T2 已完成，等待开始 M2-T3
> 下一任务：M2-T3 定义带版本号的消息协议
...
下一步严格只执行 **M2-T3：定义带版本号的消息协议**。

M2-T3 完成后必须：

1. 更新本文件中的任务勾选；
2. 将 M2-T4 设为下一任务；
3. 在完成日志中记录协议版本、消息类型、测试命令和验证结果；
4. 不越过 M2-T3 提前实现完整运行时校验或持久化。
