...
> 当前状态：M2-T5 已完成，等待开始 M2-T6
> 下一任务：M2-T6 实现任务创建、更新、查询和清理
...
| 当前任务 | 无进行中任务 |
| 最近完成 | M2-T5 建立 IndexedDB/Dexie 数据库 |
| 下一任务 | M2-T6 实现任务创建、更新、查询和清理 |
| 阻塞项 | 无 |
...
下一步严格只执行 **M2-T6：实现任务创建、更新、查询和清理**。

M2-T6 完成后必须：

1. 更新本文件中的任务勾选；
2. 将 M2-T7 设为下一任务；
3. 为创建、更新、查询、资源关联清理和重启恢复补齐测试；
4. 不越过 M2-T6 提前实现结构化错误模型。
