...
> 当前状态：M2-T4 已完成，等待开始 M2-T5
> 下一任务：M2-T5 建立 IndexedDB/Dexie 数据库
...
下一步严格只执行 **M2-T5：建立 IndexedDB/Dexie 数据库**。

M2-T5 完成后必须：

1. 更新本文件中的任务勾选；
2. 将 M2-T6 设为下一任务；
3. 记录数据库名称、schema 版本、表与索引；
4. 不越过 M2-T5 提前实现完整任务仓储服务。
