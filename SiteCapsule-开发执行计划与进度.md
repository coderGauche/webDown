...
> 当前状态：M2-T6 已完成，等待开始 M2-T7
> 下一任务：M2-T7 实现结构化错误模型
...
下一步严格只执行 **M2-T7：实现结构化错误模型**。

M2-T7 完成后必须：

1. 更新本文件中的任务勾选；
2. 将 M2-T8 设为下一任务；
3. 定义稳定错误代码、用户消息、可重试属性和最小诊断上下文；
4. 不越过 M2-T7 提前开始 M3 DOM 快照。
